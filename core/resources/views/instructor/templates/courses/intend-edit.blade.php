    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h5 class="m-0 text-dark card-title">{{__("Intended Learners")}} {{_("Edit")}} </h5>
            </div>
            ...
            <div class="col-md-8">
                <form action="{{route('instructor.course.intend_update',[$course->id])}}"  method="post">
                    ...
                    <div class="mb-5">
                        ...
                        <textarea class="form-control count-content" name="students_learn" required  maxlength="200" placeholder="Example: Define the roles and responsibilities of this subject, Case study and  identify and manage project risks." rows="3">{{$course->students_learn}}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control count-content" name="requirements" required maxlength="200" rows="3">{{$course->requirements}}</textarea>
                        <p class="text-end"><span id="counter">0</span>/200</p>
                    </div>
                    <div class="mb-3">
                        ...
                        <textarea class="form-control count-content" name="intended_learners" required maxlength="200" rows="3">{{$course->intended_learners}}</textarea>
                        <p class="text-end"><span id="counter">0</span>/200</p>
                    </div>
