...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="col-md-8">
            <p class="py-5">The following descriptions will be publicly visible on your <span class="text-primary">Course Landing Page</span> and will have a direct impact on your course performance. These descriptions will help learners decide if your course is right for them.</p>
                ...
                <form action="{{route('instructor.course.intend_store')}}"  method="post">
                    ...
                    <div class="mb-5">
                        ...
                        <textarea class="form-control" name="students_learn" placeholder="Example: Define the roles and responsibilities of this subject, Case study and  identify and manage project risks." rows="3"></textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="intended_learners" rows="3"></textarea>
                    </div>
