            ...
            <div class="col-md-8">
                <form action="{{route('instructor.course.intend_store')}}"  method="post">
                    ...
                    <div class="mb-5 pt-5">
                        ...
                        <textarea class="form-control count-content" name="title" required placeholder="Example: Python begainer to advance from scratch step by step" rows="1" maxlength="75">{{old('title')}}</textarea>
                        <p><span id="counter">0</span>/80</p>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="requirements" required maxlength="200" rows="3">{{old('requirements')}}</textarea>
                    </div>
                    <div class="mb-3">
